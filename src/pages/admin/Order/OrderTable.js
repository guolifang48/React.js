...
import {get_all_orders} from "../../../apis/admin";
                ...
                .map((n, index) => {
                  return (
                    ...
                    >
                      ...
                      <TableCell  className={classes.tableCellCenter}>{n.item.store.store_name}</TableCell>
                      <TableCell  className={classes.tableCellCenter}>{n.item.item_name}</TableCell>
                      <TableCell numeric>($) {n.amount*n.item.cost}</TableCell>
                      <TableCell  className={classes.tableCellCenter}>
                        {(n.status=='Ordered'
